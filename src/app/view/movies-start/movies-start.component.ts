...
@Component({
  ...
  styleUrls: ['./movies-start.component.sass']
})
  ...
  movies = [
    {
      ...
      year: 2019,
      img: 'https://m.media-amazon.com/images/M/MV5BMjIwMDIwNjAyOF5BMl5BanBnXkFtZTgwNDE1MDc2NTM@._V1_UX182_CR0,0,182,268_AL_.jpg',
    ...
    },
    {
      ...
      year: 2019,
      // tslint:disable-next-line:max-line-length
      img: 'https://m.media-amazon.com/images/M/MV5BNzVhMjcxYjYtOTVhOS00MzQ1LWFiNTAtZmY2ZmJjNjIxMjllXkEyXkFqcGdeQXVyNTc5OTMwOTQ@._V1_UX182_CR0,0,182,268_AL_.jpg',
    ...
    },
    {
      ...
      year: 2019,
      img: 'https://m.media-amazon.com/images/M/MV5BMTkyOTkwNDc1N15BMl5BanBnXkFtZTgwNzkyMzk3NjM@._V1_UX182_CR0,0,182,268_AL_.jpg',
    ...
    },
    {
      ...
      year: 2019,
      img: 'https://m.media-amazon.com/images/M/MV5BMjQ3MTk4Nzc1M15BMl5BanBnXkFtZTgwMTEwMDU5NjM@._V1_UX182_CR0,0,182,268_AL_.jpg',
    ...
    },
    {
      ...
      year: 2019,
      // tslint:disable-next-line:max-line-length
      img: 'https://m.media-amazon.com/images/M/MV5BM2YyYWI3NjItMWEwZS00MzhkLWJmZTMtZDAzYjRhODM0OTMzXkEyXkFqcGdeQXVyMjM4NTM5NDY@._V1_UX182_CR0,0,182,268_AL_.jpg',
